...
file_path = './S&P:TSX Composite Low Volatility Index_20181220-20191220.xls'
...
plt.title('Annualized Rolling Volatility For the Time Period December 20, 2018 to December 20, 2019')
plt.xlabel('Date')
